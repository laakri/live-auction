...
const LuxuryAuthPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen w-full bg-transparent flex items-center justify-center p-4 relative top-0 right-0 bottom-0 left-0 overflow-hidden">
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              {!isLogin && (
                ...
                >
                  <Input
                    ...
                    className="w-full bg-[#1a1a1a] text-white border-gray-700 focus:ring-gray-500"
                  />
                </motion.div>
              )}
              <Input
              ...
              <Button
                type="submit"
                disabled={isLoading}
                className="w-full bg-white text-black font-bold py-3 rounded-full transition duration-300 hover:bg-gray-200"
              >
                {isLoading
                  ? "Processing..."
                  : isLogin
          ...
          <div className="p-4 bg-[#0f0f0f]">
            <p className="text-center text-gray-400">
              ...
              <button
                ...
                className="ml-2 text-white hover:text-gray-300 font-semibold"
              >
